  ...
  <div class="" id="widget">
   ...
   <Card style="height: 9rem; overflow: hidden;box-shadow: none; border-radius: 5px;">
           ...
           <template #content> 
            ...
            <!-- #f9b115 -->
             <div class="card bg-warning text-white h-max" style="background-color: #12bf24;">
               <div class="card-body pb-0 flex justify-between align-items-start">
                 <div><div class="fs-4 fw-semibold">{{ dataModel.count? dataModel.count[1] :0 }}<span class="fs-6 fw-normal"></span>
...
import imgProject from '../../../assets/images/complete-100.png'
...
const setData = (data) => {
  ...
  data3.datasets[0].data = data.countAllMonth.complete
