    ...
    <div class="card flex border-b">
        ...
        <div class="flex justify-between w-full items-center">
            ...
            <div class="px-5 flex items-center">
                ...
                <div class="flex gap-2 items-center"><img src="../../assets/Images/Resources/3.jpg" alt="demo" class="rounded w-[30px] h-[30px]"><div class="flex flex-col"><span class="font-semibold">Admin</span><span class="text-sm">EDMS Admin</span></div></div>
            </div>
        </div>
    </div>
</template>
