<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentListProjectInfoEditFormForMobile.aspx.cs" Inherits="EDMs.Web.Controls.Document.DocumentListProjectInfoEditFormForMobile" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <telerik:RadTabStrip ID="RadTabStrip1" Skin="Metro" RenderMode="Native" runat="server" Width="100%" MultiPageID="RadMultiPage1"
            ...
            <Tabs>
                ...
                <telerik:RadTab Text="Package for MSR"></telerik:RadTab>
        ...
        <telerik:RadMultiPage runat="server" ID="RadMultiPage1" SelectedIndex="0" Height="100%" Width="100%">
                                    ...
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="divDocNo">
                                                <asp:TextBox ID="txtJOB" ReadOnly="false" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                    ...
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="divJus">
                                                <asp:TextBox ID="txtJustification" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
           ...
           <telerik:RadComboBox ID="ddlSystem" runat="server" Style="width: 250px" CssClass="form-control rounded-0 " AllowCustomText="True" MarkFirstMatch="True" Width="25px" />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextSupplier" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 450px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextContact" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                     <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div1">
                                                <asp:TextBox ID="TextMSRNo" ReadOnly="false" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                    ...
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextWono" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextAccountcode" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="Textprojectcode" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px">
                                        <div>
                                            ...
                                            <div style="float: left; padding-left:10px;padding-top: 5px; display: flex;" class="qlcbFormItem">
                                                <div>
                                    ...
                                    <li style="width:450px ;">
                                        <div>
                                            <label style="width: 100px; float: left; padding-top: 10px; padding-right: 10px; text-align: right;">
                                    ...
                                    <li style="width: 400px; display: none;">
                                        <div>
                                            <label style="width: 100px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                        ...
                        <div class="col-xl-6" style="padding-left:0">
                            <div class="tm-text-container" style="padding-left:0">
                                <ul style="list-style-type: none;padding-left:0">
                                    ...
                                    <li style="width: 470px;">
                                        <div style="display: inline;">
                                            <label style="width: 70px; float: left; padding-top:20px; padding-right: 10px; text-align: right;">
                                     ...
                                     <li style="width: 400px; display:none">
                                         <div>
                                            ...
                                            <div style="float: left; width:250px;padding-top: 5px;" class="qlcbFormItem">
                                    ...
                                    <li style="width: 400px; display: none;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextCheckby" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextPreparedby" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                    <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="Textorginator" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                      <li style="width: 400px;">
                                        ...
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextTCNH" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                     <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextExecuting_dept" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                     ...
                                     <li style="width: 400px;">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextExecutor" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                     <li style="width: 400px;">
                                        <div>
                                            <label style="width: 100px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                                                <span style="color: #2E5689; text-align: right;">Hình thức mua xắm(Procurement methods)
                                                </span>
                                            </label>
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:TextBox ID="TextProcurement_methods" runat="server" Style="width: 250px;" CssClass="form-control rounded-0 " />
                                            </div>
                                        </div>
                                        <div style="clear: both; font-size: 0;"></div>
                                    </li>
                                ...
                                <ul style="list-style-type: none;padding-left:0">
                                        ...
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <telerik:RadAsyncUpload runat="server" ID="docuploader"
                                                    ...
                                                    EnableInlineProgress="true" Width="270px"
                                    ...
                                    <li style="width: 100%;" runat="server" id="SelectType">
                                        <div>
                                            ...
                                            <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
                                                <asp:DropDownList ID="ddlType" runat="server" CssClass="min25Percent" Width="200px">
                                                    <Items>
                        ...
                        <div class="col">
                            <div style="width: 100%">
                                <telerik:RadGrid ID="grdDocument" runat="server" AllowPaging="True"
                                    ...
                                    GridLines="None" Height="450" Width="100%" Skin="Metro" RenderMode="Lightweight"
    ...
    line-height: 30px !important; color: blue !important;">Import Imtems</a>--%>
              ...
              <telerik:RadGrid RenderMode="Lightweight" ID="grdMSRItem" GridLines="None" runat="server" AllowAutomaticDeletes="True" Skin="Metro" Height="500"
                    ...
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="ID" HorizontalAlign="NotSet" EditMode="InPlace" AutoGenerateColumns="False" TableLayout="Fixed">
                       ...
                       <telerik:GridTemplateColumn DataField="IsNote" HeaderText="Note" UniqueName="IsNote">
                                ...
                                <ItemStyle HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" TextMode="MultiLine" Rows="1" Width="100%" Checked=' <%#DataBinder.Eval(Container.DataItem, "IsNote")%>' />
