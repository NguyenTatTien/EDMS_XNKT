<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportTransDataFile.aspx.cs" Inherits="EDMs.Web.Controls.Document.ImportTransDataFile" %>
        ...
        <div style="width: 100%">
            <ul style="list-style-type: none">
                ...
                <li style="width: 500px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Transmittal From
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem">
