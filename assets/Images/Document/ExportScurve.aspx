<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExportScurve.aspx.cs" Inherits="EDMs.Web.Controls.Document.ExportScurve" %>
                ...
                <li style="width: 300px;">
                    <div>
                        <label style="width: 125px; float: left; padding-top: 5px; padding-right: 10px; text-align: right;">
                            <span style="color: #2E5689; text-align: right; ">Select Facility Code
                            </span>
                        </label>
                        <div style="float: left; padding-top: 5px;" class="qlcbFormItem" runat="server" id="div1">
                            <asp:DropDownList ID="ddlFacility" runat="server" CssClass="min25Percent qlcbFormRequired" Width="316px" style="max-width: 150px"/>
                        </div>
                    </div>
         ...
         <div style="width: 100%">
            <ul style="list-style-type: none">
                <li style="width: 350px; padding-top: 10px; padding-bottom: 3px; text-align: center">
                    <telerik:RadButton ID="btnSave" runat="server" Text="Export" SingleClick="True" SingleClickText="Progressing..." OnClick="btnSave_Click" Width="120px" style="text-align: center"
>
