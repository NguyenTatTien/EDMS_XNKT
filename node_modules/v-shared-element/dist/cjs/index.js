...
function createRouteGuard(sharedElementCandidates, sharedElementCache) {
    var SharedElementRouteGuard = function (to, from, next) {
        ...
        sharedElementCandidates.forEach(function (candidate, id) {
            ...
            var element = new illusory.IllusoryElement(candidate.element, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!cachedElement)
                        return [2];
                    finished = illusory.illusory(cachedElement.element, activeElement, {
                        element: {
...
var $createIllusoryElement = function (el, opts) {
    return new illusory.IllusoryElement(el, opts);
};
...
var SharedElementDirective = {
    install: function (app, options) {
        if (!isVue3(app)) {
            app.prototype.$illusory = illusory.illusory;
        ...
        app.config.globalProperties.$illusory = illusory.illusory;
...
exports.NuxtSharedElementRouteGuard = NuxtSharedElementRouteGuard;
exports.SharedElementDirective = SharedElementDirective;
exports.SharedElementRouteGuard = SharedElementRouteGuard;
exports.createSharedElementDirective = createSharedElementDirective;
exports.sharedElementMixin = sharedElementMixin;
