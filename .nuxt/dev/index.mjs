...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/App/LDA/EDMS-FE/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/App/LDA/EDMS-FE/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/App/LDA/EDMS-FE/node_modules/devalue/index.js';
import destr from 'file://D:/App/LDA/EDMS-FE/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://D:/App/LDA/EDMS-FE/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/App/LDA/EDMS-FE/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/App/LDA/EDMS-FE/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/App/LDA/EDMS-FE/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/App/LDA/EDMS-FE/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/App/LDA/EDMS-FE/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/App/LDA/EDMS-FE/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/App/LDA/EDMS-FE/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/App/LDA/EDMS-FE/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/App/LDA/EDMS-FE/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/App/LDA/EDMS-FE/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/App/LDA/EDMS-FE/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/App/LDA/EDMS-FE/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/App/LDA/EDMS-FE/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/App/LDA/EDMS-FE/node_modules/unctx/dist/index.mjs';
import * as vue$1 from 'file://D:/App/LDA/EDMS-FE/node_modules/vue/index.mjs';
import { version, unref } from 'file://D:/App/LDA/EDMS-FE/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/App/LDA/EDMS-FE/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/App/LDA/EDMS-FE/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/App/LDA/EDMS-FE/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\App\\LDA\\EDMS-FE","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\App\\LDA\\EDMS-FE\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\App\\LDA\\EDMS-FE\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\App\\LDA\\EDMS-FE\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\App\\LDA\\EDMS-FE\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "D:/App/LDA/EDMS-FE";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Tp7xc0G7IG = (nitroApp) => {
...
const _lG4vAq21EY = defineNitroPlugin(async (nitroApp) => {
...
const _lazy_D6MPsG = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_D6MPsG, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_D6MPsG, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/App/LDA/EDMS-FE/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/App/LDA/EDMS-FE/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
